#ifndef PAR_MULTIEXP2_ORIGINAL
#define PAR_MULTIEXP2_ORIGINAL
...
class ParallelMultiexpOriginal {
...
public:
    ParallelMultiexpOriginal(Curve &_g): g(_g) {}
